...
Your friend then asks you to write 'YES' if the number is in the stack of index cards, 'NO' if it isn't, and hand them a sticky note with the answer written on it.
