...
Given a list of numbers, let's invent a process that counts how many of them are negative (i.e., less than 0).
...
Your friend then asks you to count the number of negative numbers in the stack of index cards and hand them a sticky note with the answer written on it.
